...
@section('content')
  <center>
    <h3>Laporan Keuntungan Pada Tanggal : @php echo $tanggal @endphp</h3>
    <h4>keuntungan Total hari itu : @php echo $untung_hari_itu @endphp</h4>
  </center>
  <div class="form-group">
    <label for=""><h5>Print Laporan Keuntungan Hari ini : </h5></label>
    <a href="{{route('produkKeluar.cetakPdfTanggal')}}" class="btn btn-primary" target="_blank">Print</a>
  </div>
  ...
  <table id="table_id" class="table table-striped table-bordered table-sm">
      ...
      <tbody>
          ...
          <tr>
              ...
              <td>{{$produk->jumlah_harga_jual}}</td>
              <td>
                  <a href="{{route('produkKeluar.edit', $produk->id)}}" class="btn btn-primary btn-sm"><i class="fa fa-pencil" aria-hidden="true"></i></a>
